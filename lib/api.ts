...
const products: Product[] = [
    {
        ...
        product_type: ProductType.MOISTURIZER,
...

    {
        ...
        product_type: ProductType.EXFOLIATING_CLEANSER,
        ...
        product_type: ProductType.EXFOLIATING_TONER,
...

    {
        ...
        product_type: ProductType.ANTI_AGING_SERUM,
        ...
        brand: "Neutrogena",
        skin_type: [SkinType.NORMAL, SkinType.MIXTA, SkinType.GRASA],
        product_type: ProductType.HYDRATING_GEL,
        category: [Category.HIDRATACION],
...

    {
        ...
        product_type: ProductType.REPAIR_BALM,
...

    {
        ...
        product_type: ProductType.HYDRATING_SERUM,
        category: [Category.HIDRATACION],
...

    {
        ...
        product_type: ProductType.ANTIOXIDANT_SERUM,
...

    {
        ...
        brand: "The Ordinary",
        skin_type: [SkinType.NORMAL, SkinType.MIXTA, SkinType.GRASA],
        product_type: ProductType.RETINOL_SERUM,
        category: [Category.ANTI_EDAD],
...

    {
        ...
        product_type: ProductType.FACIAL_CLEANSER,
        category: [Category.LIMPIEZA],
