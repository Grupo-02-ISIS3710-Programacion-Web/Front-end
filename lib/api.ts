...
const users: MockUser[] = [
    ...
    { id: "u3", name: "Jamie L.", avatarUrl: "https://i.pravatar.cc/80?img=36" },
    { id: "u4", name: "Mark D.", avatarUrl: "https://i.pravatar.cc/80?img=14" },
    { id: "u5", name: "Chloe V.", avatarUrl: "https://i.pravatar.cc/80?img=41" },
    { id: "u6", name: "Nina P.", avatarUrl: "https://i.pravatar.cc/80?img=44" }
];
