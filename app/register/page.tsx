...
export default function Registro() {
    const { register, handleSubmit, watch, setValue } = useForm<FormularioRegistro>({
        defaultValues: {
            nombre: "",
            fechaNacimiento: "",
            tipoPiel: "",
                ...
                <CardContent>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input type="password" placeholder="********" className={inputPrimaryClasses} {...register("confirmarContrasenia")} />
